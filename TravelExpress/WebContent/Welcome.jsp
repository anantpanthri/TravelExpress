...
<form name="myform" method="post" action="WelcomePage">

<button id="findpass" name="findpass" >Forgot Password</button>
<button id="newUser" name="newUser" >NewUserSignup</button>
<div class="form">
  <div class="forceColor"></div>
  <div class="topbar">
    <div class="spanColor"></div>
    <input type="text" class="input" id="username" name="username" placeholder="Email ID"/>
