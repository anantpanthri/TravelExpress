...
<html>
<head>
<link rel="stylesheet" href="css/air.css"> <script language="javascript"> 
...
<c:forEach items="${databaseAirList}" var="dal">
<div id="pricing-table" >
    <div class="plan">
        <h3><c:out value="${dal.service_name}" /><span><c:out value="${dal.price_per_mile}" />$</span></h3>
         
        <button class="signup" id="submit" name="submit" onclick="javascript:access('${dal.service_name}','${dal.price_per_mile}');">GoAir</button>         
        <ul>
            <li> </li>
